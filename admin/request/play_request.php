...
$pack_id = intval($router->getGET("pack"));
...
$json_sender = json_encode($sender);
$json_pack = json_encode($pack_id);
...
$receive = intval($router->getGET("receiver"));
$user = new Apps_Libs_UserIdentity();
$i = 0;
?>
<?php if ($user->getID()!= $receive){
    ...
    <script type="text/javascript">
        ...
        function ShowAll() {
            ...
            var sender = <?php echo $json_sender ?>;

            var pack = <?php echo $json_pack ?>;
            ...
            $.ajax({
                method: "POST",
                url: "request/play_request_get.php",
                data: {select: Arr_Selected,
                    answer: Arr_Result,
                    // wrong: Arr_WrongAns,
